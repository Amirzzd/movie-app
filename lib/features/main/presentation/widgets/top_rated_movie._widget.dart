...
import '../screens/top_rated_movie_list_screen.dart';
...
class TopRatedMovieWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bloc.add(TopRatedMovieListEvent());
    ...
    return BlocBuilder(
      ...
      builder: (context, state) {
        ...
        if(state is MovieListSuccess){
          ...
          // return movieListWidget(movieListModel: model, context: context, text: 'فیلم های برتر',routeName: MovieScreen.routeName);
          return Column(
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text('فیلم های برتر',style: theme.textTheme.titleLarge,),
                    GestureDetector(
                      onTap: (){
                        Navigator.of(context).pushNamed(TopRatedMovieListScreen.routeName,);
                      },
