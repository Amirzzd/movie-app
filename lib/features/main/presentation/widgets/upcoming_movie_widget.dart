...
import '../screens/upcoming_movie_list_screen.dart';
...
class UpComingMovieWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bloc.add(UpcomingMovieListEvent());
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text('بزودی',style: theme.textTheme.titleLarge,),
                    GestureDetector(
                      onTap: (){
                        Navigator.of(context).pushNamed(UpcomingMovieListScreen.routeName,);
                      },
